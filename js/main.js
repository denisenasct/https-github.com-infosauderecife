...
async function carregarPostos(userLoc) {
  try {
    const res = await fetch("https://dados.recife.pe.gov.br/api/3/action/datastore_search?resource_id=d12dd6bd-e0e5-45f5-a3b3-17a0b2e956ba&limit=1000");
    const dados = await res.json();
    todosPostos = dados.result.records.map(p => ({
      ...p,
